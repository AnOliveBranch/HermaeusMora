...
const commands = [
	new SlashCommandBuilder()
		...
		.addSubcommand((subcommand) =>
			subcommand.setName('help').setDescription('Displays information about the /nexus command'),
		)
		...
		.addSubcommand((subcommand) =>
			subcommand
				...
				.addStringOption((option) =>
					option.setName('link').setDescription('The link to the mod').setRequired(true),
				)
				.addStringOption((option) =>
					option
						.setName('version')
		...
		.addSubcommandGroup((group) =>
			group
				...
				.addSubcommand((subcommand) =>
					subcommand.setName('check').setDescription('Checks your authentication status'),
				)
				...
				.addSubcommand((subcommand) =>
					subcommand.setName('remove').setDescription('Removes your API key from the bot memory'),
				),
		),
